...
## Javascript Assignments  [![Build Status](https://travis-ci.com/Irina-syrnikova/js-assignments.svg?branch=master)](https://travis-ci.com/Irina-syrnikova/js-assignments)
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.com/Irina-syrnikova/js-assignments/builds).
